...
public class StrategieCalculConditionClimatique implements StrategieCalcul{
    ...
    public void calculer(List<int[]> pointsEnFeu, int[][] grille, List<int[]> listeIndicesFeu, double probabilite
            , boolean caseEnFeu,List<Integer> listeIndicesFeuAll,GrilleXY grilleXY,
                         int indice,double humiditeSelectioner, double tomperatureSelectioner, double vitesseVentSelectioner) {
